...
const website: Website = {
  ...
  regexp: new RegExp(
    ...
    'changelly\\.com|bybit\\.com|gate\\.io|gate\\.com|kucoin\\.com|coinmama\\.com|cex\\.io|paxful\\.com|htx\\.com|mexc\\.com|bitget\\.com|freebitco\\.in|crypto\\.com|okx\\.com|coinbase\\.com|binance\\.com|wazirx\\.com|coindcx\\.com|zebpay\\.com|bitbns\\.com)'
  ),
  init: function () {
    utils.hideButton();
    alert(1);
